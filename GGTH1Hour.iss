; GGTH1HourInstaller_v1.iss
; User-level installation with MT5 directory configuration
; Author: Jason Rusk
; Updated for GGTH 1 Hour v1.0 / unified_predictor_v8.1

#define MyAppName "GGTH 1 Hour"
...
Source: "GGTH1hour.mq5"; DestDir: "{code:GetMT5ExpertsDir}"; Flags: ignoreversion; Tasks: installEA
Source: "GGTH1hour.ex5"; DestDir: "{code:GetMT5ExpertsDir}"; Flags: ignoreversion; Tasks: installEA
...
[Icons]
Name: "{group}\GGTH 1 Hour GUI"; Filename: "{app}\run_ggth_gui.bat"; WorkingDir: "{app}"; IconFilename: "{sys}\shell32.dll"; IconIndex: 165
Name: "{group}\Setup Wizard"; Filename: "{app}\setup_wizard.bat"; WorkingDir: "{app}"
Name: "{group}\Uninstall GGTH 1 Hour"; Filename: "{uninstallexe}"
Name: "{autodesktop}\GGTH 1 Hour"; Filename: "{app}\run_ggth_gui.bat"; WorkingDir: "{app}"; Tasks: desktopicon; IconFilename: "{sys}\shell32.dll"; IconIndex: 165

[Run]
; Option to launch GUI after install
Filename: "{app}\run_ggth_gui.bat"; Description: "Launch GGTH 1 Hour GUI"; Flags: postinstall nowait skipifsilent unchecked; WorkingDir: "{app}"
...
begin
  ...
  MT5DirectoryPage := CreateInputDirPage(
    ...
    'The GGTH 1Hour saves prediction files to your MT5 Files directory ' +
  ...
  { Add the input field - THIS IS REQUIRED! }
  MT5DirectoryPage.Add('MT5 Files Path:');
...
begin
  ...
  begin
    ...
    WizardForm.FinishedLabel.Caption := 
      'GGTH 1 Hour v1 has been installed successfully!' + #13#10#13#10 +
      '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━' + #13#10 +
      ...
      'Next Steps:' + #13#10 +
      '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━' + #13#10 +
      '1. Launch GGTH 1 Hour from desktop/Start Menu' + #13#10 +

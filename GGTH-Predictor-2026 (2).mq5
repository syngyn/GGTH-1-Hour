...
#property description "GGTH ML Predictor EA - Optimized Edition"
...
#property description "Timer bug fixed: wall-clock enforced every tick AND every bar."
...
//--- Set magic number
   ...
   Print("GGTH Predictor EA v1.06 (Optimized) initialized | Magic: ",InpMagicNumber);
...
//--- Remove all chart objects
   ...
   Print("GGTH Predictor EA v1.06 deinitialized");
  }
